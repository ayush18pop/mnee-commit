...
client.on("clientReady", async () => {
  ...
  console.log(
    `📋 Registering commands to ${client.guilds.cache.size} existing guilds...`
  );
          ...
          embeds: [
            {
              ...
              description:
                "Thanks for adding me! I've set up all the slash commands for this server.",
              color: 0x00ff00,
              fields: [
                {
                  name: "Get Started",
                ...
                },
                {
                  name: "Need Help?",
                  value:
                    "Visit our [documentation](https://mnee.io/docs) or join our community for support.",
                },
              ],
              footer: {
